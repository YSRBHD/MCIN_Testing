...
public class SolicitudEquivalenciaPage extends TestBase {
	...
	private By buttonEquivalencia = By.xpath("//*[@alt=\"Equivalencia\"]");
	...
	private By comboBoxRamaDeConocimiento = By.xpath("(//*[@name=\"idRamaConocimiento\"])[1]");
	private By comboboxRamaDeConocimientoArtesYHumanidades = By
			.xpath("(//*[@data-ng-value=\"ramaConocimientoDB.idRamaConocimiento\"])[1]");
	private By radioButtonNivelAcademico = By.xpath("(//*[@name=\"optionsRadios\"])[1]");
...
//	private By textBoxEmailDatosDeNotification = By.xpath("//*[@name=\"emailNot\"]");
	...
	private By textBoxTipoDeSolicitudFP = By.xpath("(//*[@type=\"text\"])[1]");
	...
	private By textBoxRamaDeConocimiento = By.xpath("//*[@data-ng-model=\"ramaConocimientoDB.rama\"]");
...
//	}
	...
	private void assertRamaDeConocimineto() {
		scrollDown();
